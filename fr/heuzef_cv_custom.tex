...
\begin{quote}
``
Fort d'une expérience de 15 ans en tant que technicien IT, je me suis spécialisé dans la gestion de projets IT et infrastructure. Animé par le partage et le travail d’équipe, je m’attache à l'analyse des besoins pour proposer des solutions alliant pertinence et excellence opérationnelle.

\medskip

Au fil de ma carrière, j’ai souvent joué un rôle de guide, aidant à structurer et à organiser les projets. Ma capacité à jouer un rôle de facilitateur entre différents experts me permet de créer un langage commun et d'optimiser la collaboration, contribuant ainsi à l'atteinte d'objectifs ambitieux et innovants.

\medskip

Je suis particulièrement intéressé par le poste de Chef de projet IT chez vous, car je souhaite piloter des projets technologiques de grande ampleur, côtoyer des partenaires inspirants, et influencer la transformation digitale de l’industrie.
''
\end{quote}
...
\cvtag{Gestion de projets IT {\color{GoldenMetallic}\faCogs}}\\
\cvtag{Planification et organisation {\color{EngineeringOrange}\faCalendar}}
\cvtag{Suivi des budgets, délais, risques et qualité {\color{Carmine}\faChartLine}}\\
\cvtag{Synergie entre équipes IT, métier et partenaires externes {\color{ForestGreen}\faHandshake}}
\cvtag{Communication et animation des comités de pilotage {\color{EgyptianBlue}\faBullhorn}}
\\
\divider

\cvtag{KPI et indicateurs clés de performance {\color{black}\faTachometerAlt}}
\cvtag{Méthodologie Agile/Scrum {\color{GoldenMetallic}\faUsers}}
\cvtag{Conduite du changement {\color{EngineeringOrange}\faExchangeAlt}}\\
\cvtag{Satisfaction des utilisateurs finaux {\color{Carmine}\faSmile}}
\cvtag{Outils de gestion de projet (Jira, Kanban) {\color{SlateGrey}\faTasks}}
\\
\divider

\cvtag{Environnements infrastructure, applications, et sécurité IT {\color{black}\faServer}}
\cvtag{Analyse de données et production de reportings décisionnels {\color{ForestGreen}\faChartBar}}
\cvtag{Excellente communication orale et écrite {\color{EgyptianBlue}\faComment}}
\\
\divider

\cvtag{Leadership naturel {\color{GoldenMetallic}\faUserTie}}
\cvtag{Sens de l’écoute et orientation solution {\color{Carmine}\faHeadset}}
\cvtag{Appétence pour l’innovation et l’amélioration continue {\color{EngineeringOrange}\faLightbulb}}
\\
\divider
...
\item Gestion de plusieurs projets en simultané.
\item Utilisation des outils de gestion de projet (Jira, Kanban).
\item Maîtrise des environnements infrastructure, applications, et sécurité IT.
\item Capacité à piloter des projets en respectant les budgets, délais, risques et qualité.
...
\item Gestion de projets pour divers clients.
\end{itemize}
...
\item Gestion de petits projets IT.
\end{itemize}
